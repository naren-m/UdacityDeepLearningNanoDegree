...
class NeuralNetwork(object):
    ...
    def train(self, inputs_list, targets_list):
        ...
        hidden_grad = output_errors * 1 # hidden layer gradients
        ...
        self.weights_input_to_hidden += self.lr * np.dot(hidden_errors, inputs.T)   # update input-to-hidden weights with gradient descent step
...
# #### Your answer below
# 
# Model did well. It failed to factor in sesonality ( holiday season around decemner 25)
